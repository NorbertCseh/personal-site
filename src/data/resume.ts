...
export const resume = {
  ...
  title: 'Senior Software developer engineer in Test at GoTo',
  image: {
    src: '/profile.jpg',
  ...
  sections: {
    about: {
      ...
      title: 'About Me',
      content:
        "I'm a Senior Software Developer Engineer in Test with 7+ years of experience across the full testing spectrum — from manual and automation testing to owning and evolving test frameworks for web and API layers. I specialize in TypeScript-based automation with Playwright and WebdriverIO, wired into CI/CD pipelines, and I use AI tooling daily for test authoring, code generation, and documentation.",
    },
    experience: {
      id: 'experience',
      title: 'Experience',
